...
the government has holds claims on the private sector when the state is  in the ergodic set. Consistent with Proposition \ref{prop: long run forces} %XXXXXX, \textcolor{red}{Please nail down the
 %section number.}
