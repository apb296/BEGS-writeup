...
higher welfare in the economy with ad-hoc borrowing limits.  We restrict ourselves to $I=2$, $\theta_1>\theta_2=0$,  with preferences for Agent i : $U^i(c,l)=u(c)-h(l)$ and a concave utility function (that satisfies Inada conditions) for Agent 2
