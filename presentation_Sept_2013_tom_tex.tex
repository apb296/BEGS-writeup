...
\vspace{2mm}
\MyArrow{} TFP ($\theta_1$): Adjust tax rate $\tau$ or transfers $T$
...
\begin{enumerate}
 \item Suppose discount factors are constant. \textcolor{blue}{Anmol XXXX: {\em What} simple example?} In our simple example,  interest rates are countercyclical and we still have $x>0$. Consider again
 \begin{itemize}
  \item \MyArrow{} TFP
 ...
 \vspace{3mm}
 \MyArrowUp{} $x$. This achieves that same thing as having the government accumulate assets\footnote{Normalize $b_2(s)=0$}
