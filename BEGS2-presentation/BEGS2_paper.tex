...
and $s_g$ begin the good state.
		Let $x_{fb}$ be a value of  %\st{the state $x$ from which a government can implement first=best with complete markets}
...
the long rung convergence to that steady state continuation allocation.  %While we don't challenge the \citet{Aiyagari2002} counterexamples to convergence,  do hold, 
