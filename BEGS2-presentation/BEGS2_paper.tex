...
\subsection{Reason for studying special preferences}
...
It is useful first to focus on the exogenous $\mathbb{P}$ part of returns. We do that by studying an economy with  quasi-linear  utility function:
...
\mathbb{P}(s_{t+1}|s_t)$.  After studying quasi-linear preferences, we shall study preferences that express risk aversion with respect to consumption and so activate fluctuating $q_t$.
...
We execute this three step process by executing the following calculations.
(1)
