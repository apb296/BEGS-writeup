...
What is an optimal  government debt? And  is government debt  even a pertinent state variable? % in a recursive formulation of a Ramsey problem?
...
\begin{figure}[ht]
		...
		\caption{Optimal asset payoff structure as a function of initial government debt when TFP follows a 2 shock i.i.d. process (left) and when government expenditures follow a 2 shock i.i.d process (right).\label{fig:optP}}
	\end{center}	
\end{figure}
