...
\item Using the fact that the Lucas Stokey solution is stationary, we can construct the optimal payoff matrix
...
\[
 \mathbb{P}^*(s\_,s|b_{-1}) = (1-\beta)\frac{S(s,\tau)}{\EE_{s\_} S(s,\tau)} + \beta
 \]
