...
\item To focus on the exogenous $\mathbb{P}$ part of return, we first study quasi-linear  preferences  that pin down $q_t=\beta$
...
\begin{frame}
 ...
 \begin{frame}{Turning on risk-aversion}
  ...
  \item Another source of return fluctuations -- the risk-free interest rate
   ...
   Now $q_t$ varies in interesting ways \textcolor{red}{Anmol and David XXXXX: please note how I changed this bullet point and slide}
