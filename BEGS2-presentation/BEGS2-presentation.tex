...
\begin{itemize}
	...
	\item If the asset payoff structure offers lower returns in adverse states of the world, the Ramsey government  asymptotically runs up a  debt against the private sector \textcolor{red}{Anmol and David XXXXXX: do you mean `against' or `to'? (an English lesson)}
